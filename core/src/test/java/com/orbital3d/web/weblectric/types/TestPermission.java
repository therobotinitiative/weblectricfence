...
public class TestPermission
{
	...
	private static it[] t = {
			// True cases
			it.of("part1", "part1", true), it.of("part1:part2", "part1:part2", true), it.of("part1:part2:part3", "part1:part2:part3", true),
			it.of("part1:part2:part3", "part1:part2:*", true), it.of("part1:part2:part3", "part1:*:part3", true), it.of("part1:part2:part3", "*:part2:part3", true),
			// False cases
			it.of("part1", "no-perm", false), it.of("part1", "part1:notallowed", false), it.of("part1:part2:part3", "part1:part2:*", true),
			it.of("suer:duper:permission", "*", true), it.of("admin:user:add", "admin:user:*", true), it.of("admin:user:add", "admin:*", true),
			it.of("admin:user:add", "admin:user:remove", false), it.of("part1:notallowed", "part1", false), it.of("part1", "part1:notallowed", false),
			it.of("part1:part2:part3:part4", "part1:part2:*", true), it.of("part1:part2:part3:part4:part5", "part1:part2:*", true) };
